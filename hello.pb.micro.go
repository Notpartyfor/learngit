...
type SayService interface {
	...
	Hello2(ctx context.Context, in *Request2, opts ...client.CallOption) (*Response, error)
}
...
func (c *sayService) Hello2(ctx context.Context, in *Request2, opts ...client.CallOption) (*Response, error) {
	req := c.c.NewRequest(c.name, "Say.Hello2", in)
	out := new(Response)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
...
type SayHandler interface {
	...
	Hello2(context.Context, *Request2, *Response) error
}

func RegisterSayHandler(s server.Server, hdlr SayHandler, opts ...server.HandlerOption) error {
	type say interface {
		Hello(ctx context.Context, in *Request, out *Response) error
		Hello2(ctx context.Context, in *Request2, out *Response) error
	}
	type Say struct {
		say
	}
...
func (h *sayHandler) Hello2(ctx context.Context, in *Request2, out *Response) error {
	return h.SayHandler.Hello2(ctx, in, out)
}
